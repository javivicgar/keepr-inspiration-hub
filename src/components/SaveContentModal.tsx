      ...
      <div className="px-4 pt-5 pb-24">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="title" className="font-josefin">
              Title *
            </Label>
            <Input
              id="title"
          ...
          <div className="space-y-2">
            <Label htmlFor="link" className="font-josefin">
              Link *
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="creator" className="font-josefin">
              Creator
            </Label>
            <div className="relative">
          ...
          <div className="space-y-3">
            ...
            <RadioGroup
              ...
              onValueChange={(value) =>
                setFormData((prev) => ({ ...prev, category: value as SavedContent["category"] }))
              }
            ...
            >
              {[
                ...
                <div key={category} className="flex items-center space-x-2 p-2 border border-border rounded-md">
                  ...
                  <Label htmlFor={category} className="text-sm font-josefin">
                    {category}
                  </Label>
                </div>
              ))}
          ...
          {(formData.category === "Food Spots" || formData.category === "Locations") && (
            <>
              <div className="space-y-2">
                <Label htmlFor="location" className="font-josefin">
                  Location
                </Label>
                <div className="relative">
              ...
              <div className="space-y-2">
                <Label htmlFor="mapLink" className="font-josefin">
                  Map Link
                </Label>
                <Input
                  id="mapLink"
          ...
          <div className="space-y-2">
            <Label htmlFor="folder" className="font-josefin">
              Folder *
            </Label>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="tags" className="font-josefin">
              Tags
            </Label>
            <div className="relative">
          ...
          <div className="space-y-2">
            <Label htmlFor="note" className="font-josefin">
              Note
            </Label>
            <Textarea
              id="note"
