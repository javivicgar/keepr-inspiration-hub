...
export const AuthScreen = ({ onAuthenticate }: AuthScreenProps) => {
  ...
  return (
    <div className="absolute inset-0 bg-background brand-glow overflow-hidden flex flex-col">
      <div className="flex-1 w-full max-w-sm mx-auto px-6 flex flex-col justify-between items-center pt-[16%] pb-8">
        {/* Wordmark */}
