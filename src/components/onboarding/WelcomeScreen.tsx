  ...
  return (
    <div className="text-center animate-fade-in">
      <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <h1 className="text-6xl font-bold text-white mb-4 font-josefin tracking-wide">
          Hey 👋
        </h1>
        <p className="text-white/90 text-xl mb-8 font-josefin">
          Let's set things up for you.
        </p>
      </div>
      
      <div className={`flex justify-center space-x-2 mb-12 transition-opacity duration-500 ${dotsVisible ? 'opacity-100' : 'opacity-0'}`}>
